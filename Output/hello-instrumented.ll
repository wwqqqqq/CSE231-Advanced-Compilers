; ModuleID = 'hello-instrumented.bc'
...
@"keys global" = internal constant [2 x i32] [i32 1, i32 56]
@"values global" = internal constant [2 x i32] [i32 1, i32 2]
@"keys global.1" = internal constant [4 x i32] [i32 1, i32 31, i32 33, i32 56]
@"values global.2" = internal constant [4 x i32] [i32 1, i32 1, i32 1, i32 2]
@"keys global.3" = internal constant [2 x i32] [i32 1, i32 56]
@"values global.4" = internal constant [2 x i32] [i32 1, i32 1]

; Function Attrs: noinline uwtable
define internal void @__cxx_global_var_init() #0 section ".text.startup" {
  call void @updateInstrInfo(i32 2, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @"keys global", i32 0, i32 0), i32* getelementptr inbounds ([2 x i32], [2 x i32]* @"values global", i32 0, i32 0))
...
define dso_local i32 @main() #4 {
  call void @updateInstrInfo(i32 4, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @"keys global.1", i32 0, i32 0), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @"values global.2", i32 0, i32 0))
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0))
...
define internal void @_GLOBAL__sub_I_HelloWorld.cpp() #0 section ".text.startup" {
  call void @updateInstrInfo(i32 2, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @"keys global.3", i32 0, i32 0), i32* getelementptr inbounds ([2 x i32], [2 x i32]* @"values global.4", i32 0, i32 0))
